...
module FlowWizard
  # The outcome of advancing from a step: either move on to +step+ (optionally
  # flashing a notice), or re-render +step+ with an alert because the submitted
  # choice was rejected. The app decides which; its controller turns the result
  # into a redirect or a render.
  class Transition
